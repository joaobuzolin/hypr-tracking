...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen relative flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative z-10 backdrop-blur-3xl bg-background/10 border-l border-white/5 shadow-2xl">
