  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-[360px] mx-4">
        <div
          className="rounded-2xl border border-white/10 p-8 flex flex-col items-center gap-6"
          style={{
        ...
        >
          {/* Logo */}
          <HyprAdTrackLogo height={30} variant="light" />
          ...
          <button
            ...
            disabled={loading}
            className="w-full h-11 bg-white/[0.08] hover:bg-white/[0.14] active:bg-white/[0.06] border border-white/[0.12] rounded-xl flex items-center justify-center gap-2.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
